...
import Dependency.Add_Category;
...
public class Products extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Pricing Information");
        ...
        jPanel5.setBackground(new java.awt.Color(217, 227, 241));
    ...
    public void UpdateComboBox(){
        // This is to get categories for combobox rom categories table in database
        try{
        Statement s = db.mycon().createStatement();
        ResultSet res = s.executeQuery("select * from categories");
        while(res.next()){
        String name=res.getString("Category");
    ...
    //this is to clear existing combobox items
    ...
    private void searchProduct(String productID) {
        try {
            ...
            if (res.next()) {
                ...
                jTextField2.setText(res.getString("ProductName"));
                jTextField3.setText(res.getString("Barcode"));
                jTextField4.setText(res.getString("BuyingPrice"));
                jTextField5.setText(res.getString("MRP"));
                jTextField6.setText(res.getString("SellingPrice"));
                jTextField7.setText(res.getString("Quantity"));
                jTextField8.setText(res.getString("MinQTY"));
                jComboBox1.setSelectedItem(res.getString("Category"));
            } else {
                JOptionPane.showMessageDialog(null, "No product found with ProductID: " + productID, "Product Not Found", JOptionPane.ERROR_MESSAGE);
            }
        } catch (SQLException e) {
            System.out.println(e);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Add_Category productsFrame = new Add_Category(this);
        productsFrame.setLocationRelativeTo(null); // Center the window
    ...
    jTextField1.setText("");
    jTextField2.setText("");
    jComboBox1.setSelectedIndex(0); // Assuming the first item is the default
    jTextField3.setText(""); // Assuming jTextField3 is the Barcode field
    jTextField4.setText("");
    jTextField5.setText("");
    jTextField6.setText("");
    jTextField7.setText("");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int minqty = Integer.parseInt(jTextField8.getText());
    ...
    if (dialogResult == JOptionPane.YES_OPTION) {
        try {
            Statement s = db.mycon().createStatement();
            s.executeUpdate("delete from products where productID='" + deleteID + "'");
        } catch (SQLException e) {
            System.out.println(e);
        }
      }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        //Update Product
        String IDForUpdate = jTextField1.getText();
    String updatedName = jTextField2.getText();
    String updatedCategory=(String) jComboBox1.getSelectedItem();
    String updatedBarcode = jTextField3.getText();
    String updatedBP = jTextField4.getText();
    String updatedMRP = jTextField5.getText();
    String updatedSP = jTextField6.getText();
    String updatedQTY = jTextField7.getText();
    String updatedMinqty = jTextField8.getText();
    ...
    if (dialogResult == JOptionPane.YES_OPTION) {
        try {
            Statement s = db.mycon().createStatement();
            s.executeUpdate("update products set ProductName='" + updatedName + "', Category='" + updatedCategory + "',Barcode='"+updatedBarcode+"', BuyingPrice='"+updatedBP+"',MRP='"+updatedMRP+"', SellingPrice='"+updatedSP+"', Quantity='"+updatedQTY+"', MinQTY='"+updatedMinqty+"' where ProductId='"+IDForUpdate+"'");
        } catch (SQLException e) {
            System.out.println(e);
        }
      }
