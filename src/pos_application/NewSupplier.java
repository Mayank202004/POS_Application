...
public class NewSupplier extends javax.swing.JFrame {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addComponent(rSMaterialButtonRectangle1, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(48, 48, 48))
        );
    ...
    private void rSMaterialButtonRectangle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonRectangle1ActionPerformed
        ...
        try{
            ...
            s.executeUpdate(" insert into supplier (SupplierName,SupplierPhoneNumber) values ('"+name+"','"+phone+"')");
            ResultSet res = s.executeQuery("select * from Supplier where SupplierPhoneNumber=('"+phone+"')");
            while(res.next()){
            String id=res.getString("SupplierID");
            Purchase.setSupplierDetails(id,name,phone);} //calling setter method for sales
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewSupplier(Purchase).setVisible(true);
            }
        });
    }
